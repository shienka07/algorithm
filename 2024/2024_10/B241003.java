...
입력
입력은 여러 개의 테스트 케이스로 이루어져 있다. 각 테스트 케이스는 한 줄로 이루어져 있고, n0으로 이루어져 있다. 
(0 < n0 < 1,000,000) 입력의 마지막 줄에는 0이 하나 주어진다.
...
public class B241003 {
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            if (cal % 2 == 0) {
                cal = (((cal * 3) / 2) * 3) / 9;
                System.out.println(cnt + ". even " + cal);
            } else {
                cal = ((((cal * 3) + 1) / 2) * 3) / 9;
                System.out.println(cnt + ". odd " + cal);
            }
