...
유형은 각 경우를 나타내는 알파벳 한 글자씩을 따서 네 글자로 표시한다. 다음은 MBTI의 유형들이다.
...
public class B240514 {
    public static void main(String[] args) throws IOException{
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        String[] mbti = br.readLine().split("");
        StringBuilder sb = new StringBuilder();

        sb.append(mbti[0].equals("E") ? "I" : "E");
        sb.append(mbti[1].equals("S") ? "N" : "S");
        sb.append(mbti[2].equals("T") ? "F" : "T");
        sb.append(mbti[3].equals("J") ? "P" : "J");
