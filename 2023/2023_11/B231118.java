...
public class B231118 {
    public static void main(String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        double[] scrList = {4.5, 4.0, 3.5, 3.0, 2.5, 2.0, 1.5, 1.0, 0.0, 0.0};
        String[] grdList = {"A+", "A0", "B+", "B0", "C+", "C0", "D+", "D0", "F", "P"};
        double sumScore = 0;
        double sumNum = 0;
        double avg = 0;
        ...
        for(int i = 0; i < 20; i++){
            ...
            for(int j = 0; j < 10; j++) {
                if(grade.equals(grdList[j])){
                    sumNum += score * scrList[j];
                    if(j != 9) {
                        sumScore += score;
                    }
                }
